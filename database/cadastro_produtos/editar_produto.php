...
if($conexao == false){
    ...
    $resultadoCategoria = pg_query($conexao, $sqlCategorias);
    ...
    $resultadoProduto = pg_query($conexao, $sqlProduto);
            ...
            <div class="col-md-7">
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <h1 class="h4 mb-4">Edição de Produto</h1>
                        ...
                        <form action="edicao_produto.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                >
                                    ...
                                    <?php
                                    while ($categoria = pg_fetch_assoc($resultadoCategoria)):?>
